...
public class blog {
	...
	public static void main(String args[]) throws SQLException,
		...
		Connection c = DriverManager
				.getConnection("mongodb://10.241.14.41:12340/exampledb");
		...
		PreparedStatement psUpdate = c
				.prepareStatement("update blogposts set tags=addtoset(?) where title='first post!'");
		psUpdate.setInt(1, 5);
...
//		System.out.println(mc.getCollection("blogposts").find().toArray());
		...
		print("num should be 2 ", st
				.executeQuery("select * from blogposts where tags='bar'"));
