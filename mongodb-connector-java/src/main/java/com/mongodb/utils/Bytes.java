...
public class Bytes extends BSON {
    ...
    public static Logger LOGGER = Logger.getLogger( "com.mongodb" );
    ...
    public static final int MAX_OBJECT_SIZE = 1024 * 1024 * 4;
    
    public static final int CONNECTIONS_PER_HOST = Integer.parseInt( System.getProperty( "MONGO.POOLSIZE" , "10" ) );
